...
World database table `playercreateinfo_action`.
...
| <a id="col-button"></a>`button` | `smallint(5) unsigned` | NO | `PRI` | `0` |  | non-negative numeric value |
| <a id="col-action"></a>`action` | `int(10) unsigned` | NO |  | `0` |  | non-negative numeric value |
| <a id="col-type"></a>`type` | `smallint(5) unsigned` | NO |  | `0` |  | non-negative numeric value |
...
| Kind | Name | Columns |
| --- | --- | --- |
| PRIMARY | `PRIMARY` | `race`, `class`, `button` |
