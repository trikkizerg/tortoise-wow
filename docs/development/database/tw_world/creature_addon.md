...
| <a id="col-display-id"></a>`display_id` | `smallint(5) unsigned` | NO |  | `0` |  | non-negative numeric value |
| <a id="col-mount-display-id"></a>`mount_display_id` | `smallint(6)` | NO |  | `-1` |  | numeric value |
| <a id="col-equipment-id"></a>`equipment_id` | `int(11)` | NO |  | `-1` |  | numeric value |
| <a id="col-stand-state"></a>`stand_state` | `tinyint(3) unsigned` | NO |  | `0` |  | non-negative numeric value; Uses UnitStandStateType enum values |
| <a id="col-sheath-state"></a>`sheath_state` | `tinyint(3) unsigned` | NO |  | `1` |  | non-negative numeric value; Uses SheathState enum values |
| <a id="col-emote-state"></a>`emote_state` | `smallint(5) unsigned` | NO |  | `0` |  | non-negative numeric value; Uses Emote enum values |
...
Value set: `UnitStandStateType` (enum) from `src/game/Objects/UnitDefines.h enum UnitStandStateType`.

### `sheath_state`

non-negative numeric value.

Value set: `SheathState` (enum) from `src/game/Objects/UnitDefines.h enum SheathState`.
...
| --- | --- | --- | --- |
| `guid` | [`creature`](creature.md).`guid` | explicit | spawn addon |
...
| --- | --- | --- | --- | --- |
| `Emote` | enum | [`emote_state`](#col-emote-state) | `src/game/SharedDefines.h enum Emote` | 117 |
| `SheathState` | enum | [`sheath_state`](#col-sheath-state) | `src/game/Objects/UnitDefines.h enum SheathState` | 3 |
| `UnitStandStateType` | enum | [`stand_state`](#col-stand-state) | `src/game/Objects/UnitDefines.h enum UnitStandStateType` | 9 |

### Possible Values

Used by: [`emote_state`](#col-emote-state)
...
Used by: [`sheath_state`](#col-sheath-state)

#### `SheathState`

Kind: `enum`

Source: `src/game/Objects/UnitDefines.h enum SheathState`

Stored in UNIT_FIELD_BYTES_2 byte 0; controls whether the spawned unit is unarmed, melee-sheathed, or ranged-sheathed.

| Decimal | Hex | Name | Meaning |
| --- | --- | --- | --- |
| `0` | `0x0` | `SHEATH_STATE_UNARMED` | Unarmed / non-prepared weapon |
| `1` | `0x1` | `SHEATH_STATE_MELEE` | Melee / prepared melee weapon |
| `2` | `0x2` | `SHEATH_STATE_RANGED` | Ranged / prepared ranged weapon |

Used by: [`stand_state`](#col-stand-state)

#### `UnitStandStateType`

Kind: `enum`

Source: `src/game/Objects/UnitDefines.h enum UnitStandStateType`

Stored in UNIT_FIELD_BYTES_1 byte 0; creature addon rows use it to force a spawn stand/sit/sleep/dead/kneel state.

| Decimal | Hex | Name | Meaning |
| --- | --- | --- | --- |
| `0` | `0x0` | `UNIT_STAND_STATE_STAND` | Stand |
| `1` | `0x1` | `UNIT_STAND_STATE_SIT` | Sit |
| `2` | `0x2` | `UNIT_STAND_STATE_SIT_CHAIR` | Sit Chair |
| `3` | `0x3` | `UNIT_STAND_STATE_SLEEP` | Sleep |
| `4` | `0x4` | `UNIT_STAND_STATE_SIT_LOW_CHAIR` | Sit Low Chair |
| `5` | `0x5` | `UNIT_STAND_STATE_SIT_MEDIUM_CHAIR` | Sit Medium Chair |
| `6` | `0x6` | `UNIT_STAND_STATE_SIT_HIGH_CHAIR` | Sit High Chair |
| `7` | `0x7` | `UNIT_STAND_STATE_DEAD` | Dead |
| `8` | `0x8` | `UNIT_STAND_STATE_KNEEL` | Kneel |
