---
layout: default
title: creature_movement_scripts
---

# creature_movement_scripts

World database table `creature_movement_scripts`.
...
References: [`creature_movement`](creature_movement.md).`id`.
...
| `id` | [`creature_movement`](creature_movement.md).`id` | explicit | movement script path |

### Incoming References

| Source | Target Column | Confidence | Notes |
| --- | --- | --- | --- |
| [`creature_movement_template`](creature_movement_template.md).`script_id` | `id` | explicit | movement script |
