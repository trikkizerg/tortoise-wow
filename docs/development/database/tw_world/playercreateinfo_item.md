...
World database table `playercreateinfo_item`.
...
| <a id="col-itemid"></a>`itemid` | `mediumint(8) unsigned` | NO |  | `0` |  | non-negative numeric value |
| <a id="col-amount"></a>`amount` | `tinyint(3) unsigned` | NO |  | `1` |  | non-negative numeric value |
