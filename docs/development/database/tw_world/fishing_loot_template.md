...
| --- | --- | --- | --- | --- | --- | --- |
| <a id="col-entry"></a>`entry` | `mediumint(8) unsigned` | NO | `PRI` | `0` |  | entry 0 used for junk loot at fishing fail (if allowed by config option); non-negative numeric value; identifier column |
