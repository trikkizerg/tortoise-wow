...
World database table `broadcast_text`.
...
| <a id="col-male-text"></a>`male_text` | `longtext` | YES |  | `NULL` |  | text/string data |
| <a id="col-female-text"></a>`female_text` | `longtext` | YES |  | `NULL` |  | text/string data |
| <a id="col-chat-type"></a>`chat_type` | `tinyint(3) unsigned` | NO |  | `0` |  | non-negative numeric value; Uses ChatType enum values |
| <a id="col-sound-id"></a>`sound_id` | `smallint(5) unsigned` | NO |  | `0` |  | non-negative numeric value |
| <a id="col-language-id"></a>`language_id` | `tinyint(3) unsigned` | NO |  | `0` |  | non-negative numeric value; Uses Language enum values |
| <a id="col-emote-id1"></a>`emote_id1` | `smallint(5) unsigned` | NO |  | `0` |  | non-negative numeric value; Uses Emote enum values |
| <a id="col-emote-id2"></a>`emote_id2` | `smallint(5) unsigned` | NO |  | `0` |  | non-negative numeric value; Uses Emote enum values |
| <a id="col-emote-id3"></a>`emote_id3` | `smallint(5) unsigned` | NO |  | `0` |  | non-negative numeric value; Uses Emote enum values |
| <a id="col-emote-delay1"></a>`emote_delay1` | `mediumint(8) unsigned` | NO |  | `0` |  | non-negative numeric value; time/delay value; confirm unit in server usage |
| <a id="col-emote-delay2"></a>`emote_delay2` | `mediumint(8) unsigned` | NO |  | `0` |  | non-negative numeric value; time/delay value; confirm unit in server usage |
| <a id="col-emote-delay3"></a>`emote_delay3` | `mediumint(8) unsigned` | NO |  | `0` |  | non-negative numeric value; time/delay value; confirm unit in server usage |
...
Value set: `ChatType` (enum) from `src/game/Objects/Creature.h enum ChatType`.

### `sound_id`

non-negative numeric value.

References: [`sound_entries`](sound_entries.md).`entry`.
...
| --- | --- | --- | --- |
| `sound_id` | [`sound_entries`](sound_entries.md).`entry` | heuristic | inferred from column name |

### Incoming References

| Source | Target Column | Confidence | Notes |
| --- | --- | --- | --- |
| [`locales_broadcast_text`](locales_broadcast_text.md).`entry` | `entry` | explicit | localized row |
| [`gossip_menu`](gossip_menu.md).`text_id` | `entry` | heuristic | inferred from column name |
| [`npc_gossip`](npc_gossip.md).`textid` | `entry` | heuristic | inferred from column name |
...
| --- | --- | --- | --- | --- |
| `ChatType` | enum | [`chat_type`](#col-chat-type) | `src/game/Objects/Creature.h enum ChatType` | 7 |
| `Emote` | enum | [`emote_id1`](#col-emote-id1), [`emote_id2`](#col-emote-id2), [`emote_id3`](#col-emote-id3) | `src/game/SharedDefines.h enum Emote` | 117 |
| `Language` | enum | [`language_id`](#col-language-id) | `src/game/SharedDefines.h enum Language` | 15 |

### Possible Values

Used by: [`chat_type`](#col-chat-type)

#### `ChatType`

Kind: `enum`

Source: `src/game/Objects/Creature.h enum ChatType`

`broadcast_text.chat_type` is loaded by `ObjectMgr::LoadBroadcastTexts` and validated against `CHAT_TYPE_ZONE_YELL`. These values are broadcast-text chat categories, not the full `ChatMsg` packet enum.

| Decimal | Hex | Name | Meaning |
| --- | --- | --- | --- |
| `0` | `0x0` | `CHAT_TYPE_SAY` | Monster say |
| `1` | `0x1` | `CHAT_TYPE_YELL` | Monster yell |
| `2` | `0x2` | `CHAT_TYPE_TEXT_EMOTE` | Monster text emote |
| `3` | `0x3` | `CHAT_TYPE_BOSS_EMOTE` | Monster boss emote |
| `4` | `0x4` | `CHAT_TYPE_WHISPER` | Monster whisper |
| `5` | `0x5` | `CHAT_TYPE_BOSS_WHISPER` | Monster boss whisper |
| `6` | `0x6` | `CHAT_TYPE_ZONE_YELL` | Monster zone yell |

Used by: [`emote_id1`](#col-emote-id1), [`emote_id2`](#col-emote-id2), [`emote_id3`](#col-emote-id3)
...
Used by: [`language_id`](#col-language-id)
