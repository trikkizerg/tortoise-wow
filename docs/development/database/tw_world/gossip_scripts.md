---
layout: default
title: gossip_scripts
---

# gossip_scripts

World database table `gossip_scripts`.
...
References: [`gossip_menu_option`](gossip_menu_option.md).`action_script_id`.
...
| `id` | [`gossip_menu_option`](gossip_menu_option.md).`action_script_id` | explicit | gossip action script |
