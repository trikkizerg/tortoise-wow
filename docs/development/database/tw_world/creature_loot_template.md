...
| --- | --- | --- | --- | --- | --- | --- |
| <a id="col-entry"></a>`entry` | `mediumint(8) unsigned` | NO | `PRI` | `0` |  | entry 0 used for player insignia loot; non-negative numeric value; identifier column |
...
| <a id="col-groupid"></a>`groupid` | `tinyint(3) unsigned` | NO | `PRI` | `0` |  | non-negative numeric value |
...
| Kind | Name | Columns |
| --- | --- | --- |
| PRIMARY | `PRIMARY` | `entry`, `item`, `groupid` |
...
| --- | --- | --- | --- |
| [`creature_template`](creature_template.md).`loot_id` | `entry` | explicit | creature loot id |
