...
| <a id="col-sound"></a>`sound` | `mediumint(8) unsigned` | NO |  | `0` |  | non-negative numeric value |
| <a id="col-type"></a>`type` | `tinyint(3) unsigned` | NO |  | `0` |  | non-negative numeric value |
| <a id="col-language"></a>`language` | `tinyint(3) unsigned` | NO |  | `0` |  | non-negative numeric value; Uses Language enum values |
| <a id="col-emote"></a>`emote` | `smallint(5) unsigned` | NO |  | `0` |  | non-negative numeric value; Uses Emote enum values |
...
| --- | --- | --- | --- | --- |
| `Emote` | enum | [`emote`](#col-emote) | `src/game/SharedDefines.h enum Emote` | 117 |
| `Language` | enum | [`language`](#col-language) | `src/game/SharedDefines.h enum Language` | 15 |

### Possible Values

Used by: [`emote`](#col-emote)
