...
| --- | --- | --- | --- | --- | --- | --- |
| <a id="col-guid"></a>`guid` | `int(10) unsigned` | NO | `PRI` |  |  | creature.guid of the slave mob that is linked; non-negative numeric value; identifier column |
| <a id="col-master-guid"></a>`master_guid` | `int(10) unsigned` | NO |  |  |  | master to trigger events; non-negative numeric value |
| <a id="col-flag"></a>`flag` | `mediumint(8) unsigned` | NO |  |  |  | flag - describing what should happen when; non-negative numeric value; mask/flags column; combine values with bitwise OR; Uses CreatureLinkingFlags mask values |
