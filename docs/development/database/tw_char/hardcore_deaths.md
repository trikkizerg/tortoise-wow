---
layout: default
title: hardcore_deaths
---

# hardcore_deaths

Character database table `hardcore_deaths`.
...
| <a id="col-race"></a>`race` | `mediumint(8) unsigned` | NO |  | `0` |  | non-negative numeric value; race id or race mask; Uses Races enum values |
| <a id="col-class"></a>`class` | `mediumint(8) unsigned` | NO |  | `0` |  | non-negative numeric value; class id or class mask; Uses Classes enum values |
| <a id="col-level"></a>`level` | `int(10) unsigned` | NO |  |  |  | non-negative numeric value |
| <a id="col-attackerentry"></a>`attackerEntry` | `int(10) unsigned` | NO |  |  |  | non-negative numeric value |
...
| <a id="col-mapid"></a>`mapId` | `int(10) unsigned` | NO |  | `0` |  | non-negative numeric value |
